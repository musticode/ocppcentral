...
class NotificationService {
  ...
  async updateNotification(id, updateData) {
    ...
    return await this.notification.findOneAndUpdate({ _id: id, isDeleted: false }, payload, { new: true })
  }
  ...
  async createNotification(userId, notificationData) {
    ...
    const notification = new this.notification({ ...notificationData, userId })
    await notification.save()
    return notification
  }
}
